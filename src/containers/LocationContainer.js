        ...
        return (
            <Container fluid style={{ margin: "2em 0 0 0 " }} textAlign="center">
                ...
                <Grid style={{ margin: "0 2em" }} columns={addingLocation ? 2 : 1}>
                    ...
                    <Grid.Column>
                        {selectedLocation && !addingLocation ? <LocationDetails selectedLocation={selectedLocation} handleShowAll={this.handleShowAll} favorites={this.props.favorites} handleFavoriteClick={this.props.handleFavoriteClick} /> :
